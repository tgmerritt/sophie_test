...
RSpec.describe Orchestration do
  ...
  context "With invalid JSON or Error" do 
    it "handles over daily limit Houndify error" do
      ...
      expect(response[:answer]).to eq (
          "{\"answer\":\"Sorry, I cannot answer that right now\",\"instructions\":{\"expressionEvent\":[{}],\"emotionalTone\":[{\"tone\":\"happiness\",\"value\":0.5,\"start\":2,\"duration\":4,\"additive\":true,\"default\":true}],\"displayHtml\":{\"html\":null}}}"
      )
    end
  end
  ...
  context "With emotion in the Houndify response" do
    ...
    it "parses the emotion into a proper emotionalInstruction" do 
      expect(response[:answer]).to eq (
        "{\"answer\":\"The CEO of unique is Danny Tomsett\",\"instructions\":{\"expressionEvent\":[{\"expression\":\"wink\",\"value\":0.5,\"start\":2,\"duration\":5}],\"emotionalTone\":[{\"tone\":\"happiness\",\"value\":0.5,\"start\":2,\"duration\":4,\"additive\":true,\"default\":true}],\"displayHtml\":{\"html\":\"<link rel='stylesheet' href='//static.midomi.com/corpus/H_Zk82fGHFX/build/css/templates.min.css'><script src='//static.midomi.com/corpus/H_Zk82fGHFX/build/js/templates.min.js'></script><div class='h-template h-image-carousel-wrapper'>   <div class='h-image-carousel h-image-carousel-Small' data-carousel-id='h-image-carousel-0'><img src='http://i2.wp.com/www.makelemonade.nz/wp-content/uploads/2018/11/Danny-Tomsett.jpg'> <h1>Danny Tomsett</h1><caption>Giant among men</caption></div>   </div>\"}}}"
    )  
    end
